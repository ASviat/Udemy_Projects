...
//
//    The Album class will be modified to use an inner class called SongList which will replace the ArrayList that was
//    used to hold the list of songs for an album.
//
//    The SongList inner class will use an ArrayList to hold the track list for the album.
//    To do this a member variable called songs will need to be declared and a constructor will need to be implemented
//    to initialize the field.
//
//    In addition, the inner class will need three(3) methods:
//
//            1) add - accepts a parameter of type Song. This method returns a boolean value which will be false if
//            the song is found to already be in the songs list. If not, the song will be added to the list and a value
